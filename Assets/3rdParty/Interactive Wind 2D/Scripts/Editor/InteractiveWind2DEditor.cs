...
{
    [CustomEditor(typeof(InteractiveWind2D)), CanEditMultipleObjects]
    public class InteractiveWind2DEditor : Editor
    {
        bool displaySetup;
        ...
        public override void OnInspectorGUI()
        {
            ...
            InteractiveWind2D wind = (InteractiveWind2D)target;
            ...
            DisplayHints(ref displayTroubleshooting, "Troubleshooting",
                ...
                "- Do <b>not</b> use <b>Sprite Sheets</b> or <b>Atlases</b> for wind sprites.",
                " ",
        ...
        public static void DisplayHints(ref bool toggleVariable, string title,params string[] lines)
        {
            GUIStyle style = new GUIStyle(GUI.skin.label);
            style.richText = true;
